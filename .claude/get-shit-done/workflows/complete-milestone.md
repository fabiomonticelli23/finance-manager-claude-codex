...
```bash
node "C:/Users/super/Documents/finance-manager-claude-codex/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Users/super/Documents/finance-manager-claude-codex/.claude/get-shit-done/templates/retrospective.md`.
