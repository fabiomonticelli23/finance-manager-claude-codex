...
```
Task(
  prompt="Read C:/Users/super/Documents/finance-manager-claude-codex/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/super/Documents/finance-manager-claude-codex/.claude/get-shit-done/templates/SECURITY.md`
